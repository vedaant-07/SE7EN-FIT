    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden">
      {rows.map((row, index) => (
        <button
          ...
          className={`w-full flex items-center gap-2 px-4 py-3 text-left hover:bg-muted/35 active:scale-[0.995] transition-all ${index !== rows.length - 1 ? 'border-b border-border/60' : ''}`}
        >
